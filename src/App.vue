...
<template>
  <div class="project-root min-h-screen flex flex-col bg-zinc-950 text-zinc-100 sm:px-16 isolate">
    ...
    <!-- Top Header -->
    <header class="w-full shrink-0 z-20 pt-12 sm:pt-0 pb-4 sm:pb-4">
    ...
    <div class="flex-1 flex flex-col">
      ...
      <aside class="order-1 w-full h-auto shrink-0 bg-zinc-950 z-10 px-4 pb-4">
      ...
      <!-- Main Viewport -->
      <main class="order-2 flex-1 relative overflow-y-auto text-zinc-950 bg-zinc-950 custom-scrollbar">
